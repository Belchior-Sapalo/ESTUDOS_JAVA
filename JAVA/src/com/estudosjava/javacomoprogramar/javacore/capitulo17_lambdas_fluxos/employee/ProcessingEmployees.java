package com.estudosjava.javacomoprogramar.javacore.capitulo17_lambdas_fluxos.employee;
...
public class ProcessingEmployees {
    public static void main(String[] args) {
        ...
        System.out.printf("Sum of Employees' salaries (via reduce method): %.2f%n", list.stream().mapToDouble(Employee::getSalary).reduce(0, (a, b) -> a + b));
